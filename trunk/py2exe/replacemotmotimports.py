...
for filename in glob.glob('*.py'):
    ...
    for line in fidin:
        lineno+=1
        allsnew = ['imops','wxvalidatedtext','wxvideo','wxglvideo','simple_overlay','ufmf','arrayimage','FlyMovieFormat']
        alls = ['motmot.imops.imops','motmot.wxvalidatedtext.wxvalidatedtext',
                ...
                'motmot.ufmf.ufmf','pygarrayimage.arrayimage','motmot.FlyMovieFormat.FlyMovieFormat']
