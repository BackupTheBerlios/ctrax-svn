...
if length(varargin) >= 2,
  handles = initializeproperties(handles,varargin{2});
else
...
handles.ignore = {'x','y','theta','a','b','id','moviename','firstframe','arena','f2i',...
  ...
  'thetadiff','phidiff','anglefrom2to1'};
