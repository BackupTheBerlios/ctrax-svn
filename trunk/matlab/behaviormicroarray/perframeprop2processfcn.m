...
processdataclosest_fns = {'absdangle2wall','dcenter','closestfly_center','dnose2ell',...
  ...
  'absanglefrom2to1_center','absanglefrom2to1_nose2ell','absanglefrom2to1_ell2nose',...
  'absanglefrom2to1_anglesub','ddcenter','ddnose2ell','ddell2nose','danglesub'};

processdatapair_fns = {'fly1','distnose2ell','magveldiff','dcenter','veltoward','thetadiff',...
  'absthetadiff','phidiff','absphidiff','minvelmag','maxvelmag','anglefrom2to1','absanglefrom2to1'};
